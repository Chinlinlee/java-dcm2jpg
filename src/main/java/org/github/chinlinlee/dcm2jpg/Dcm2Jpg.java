...
public class Dcm2Jpg {
    ...
    public final void setIccProfileFromString(String iccProfileName) throws ParseException {
        try {
            this.setICCProfile(ICCProfile.Option.valueOf(iccProfileName));
    ...
    public final void setReadImageDicomInput() {
        this.readImage = this::readImageFromDicomInputStream;
    }

    public final void setReadImageImageInput() {
        this.readImage = this::readImageFromImageInputStream;
    }
